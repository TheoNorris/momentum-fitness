...
class UserProfile(models.Model):
    """
    A user profile for maintaining delivery and membership
    ...
    membership = models.CharField(max_length=10, null=True, blank=True)
...
def create_or_update_user_profile(sender, instance, created, **kwarggs):
    """
